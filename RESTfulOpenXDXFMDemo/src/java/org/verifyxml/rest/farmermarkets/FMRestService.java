...
/**
 * Sample XML RESTful Web Service for Farmer Markets Search Demo.
 * 
 * @author Serge Leontiev <sergeleo@users.sourceforge.net>
 */

@Path("/rest")
public class FMRestService {
    
    private static final Logger LOG = Logger.getLogger(FMRestService.class.getName()); 
     ...
     */
    public FMRestService() {
        openXDXHandler = new OpenXDXHandler();
    }
    
    @GET @Path("XML/marketSearch")  
    @Produces(MediaType.APPLICATION_XML)
    public Response getXml(@QueryParam("zip") String zip) {
        // Set Response builder
        Response.ResponseBuilder response;
        try{
            Map<String, String> tokens = new HashMap<String, String>();
            tokens.put("$ZIPSearch", zip);
            String xml = openXDXHandler.getOpenXDX(openXDXHandler.farmMarketTemplateFile, tokens);
            if(xml != null){
    ...
    @GET @Path("JSON/marketSearch")    
    @Produces(MediaType.APPLICATION_JSON)
    public Response getJSON(@QueryParam("zip") String zip) {
        // Set Response builder
        Response.ResponseBuilder response;
        try{
            Map<String, String> tokens = new HashMap<String, String>();
